...
- **`architecture_diagram.mermaid`**: Source code of the voice pipeline architecture flowchart.
- **`state_machine.mermaid`**: Source code of the enforced customer authentication state diagram.
